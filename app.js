...
const PILLARS = [
  {
    ...
    ar:{title:'وجود الله',mind:'الكون المنظم بقوانينه الدقيقة لا يمكن أن يكون وليد الصدفة. كل ذرة فيه تشهد بوجود خالق حكيم.',heart:'القلب يشعر بالله قبل أن يثبته العقل. الفطرة السليمة تهتدي إلى خالقها كما يهتدي الطفل إلى أمه.',verse:'وَفِي الْأَرْضِ آيَاتٌ لِّلْمُوقِنِينَ ۝ وَفِي أَنفُسِكُمْ أَفَلَا تُبْصِرُونَ',verseRef:'سورة الذاريات ٥١: ٢٠-٢١',reflection:'انظر حولك: السماء، الأرض، جسدك — كل شيء يقول: الله موجود.',young:'الكون كله مثل كتاب جميل — لا بد أن له كاتباً حكيماً! 🌟'},
    en:{title:'God\'s Existence',mind:'A universe governed by precise laws cannot be the product of chance. Every atom testifies to a wise Creator.',heart:'The heart feels God before the mind proves Him. Pure human nature is drawn to its Creator as a child is drawn to its mother.',verse:'And on the earth are signs for the certain. And in yourselves — do you not see?',verseRef:'Surah Adh-Dhariyat 51:20-21',reflection:'Look around you: the sky, the earth, your own body — everything says: God exists.',young:'The whole universe is like a beautiful book — it must have a wise Author! 🌟'},
    fr:{title:'L\'Existence de Dieu',mind:'Un univers regi par des lois precises ne peut etre le fruit du hasard. Chaque atome temoigne d\'un Createur sage.',heart:'Le coeur ressent Dieu avant que la raison ne Le prouve. La nature pure de l\'homme est attiree vers son Createur comme un enfant vers sa mere.',verse:'Et sur la terre il y a des signes pour ceux qui croient fermement. Et en vous-memes. Ne voyez-vous pas ?',verseRef:'Sourate Adh-Dhariyat 51:20-21',reflection:'Regardez autour de vous : le ciel, la terre, votre corps — tout dit : Dieu existe.',young:'L\'univers est comme un beau livre — il doit avoir un Auteur sage ! 🌟'}
  },
  {
    id:2, emoji:'💪', theme:'god',
    ar:{title:'قدرة الله المطلقة',mind:'العلم يكشف كل يوم عن عظمة جديدة في الكون — مجرات بعيدة، ذرات دقيقة، خلايا معقدة — كلها تشهد بقدرة لا حدود لها.',heart:'عندما تشعر بالعجز، تذكّر أن الله الذي خلق هذا الكون العظيم قادر على حل مشاكلك الصغيرة.',verse:'إِنَّمَا أَمْرُهُ إِذَا أَرَادَ شَيْئًا أَن يَقُولَ لَهُ كُن فَيَكُونُ',verseRef:'سورة يس ٣٦: ٨٢',reflection:'تأمّل في قطرة ماء واحدة — كم فيها من عجائب! فكيف بمن خلقها؟',young:'الله خلق المجرات الضخمة وخلق الخلايا الصغيرة — قدرته لا حدود لها! 💫'},
    en:{title:'God\'s Absolute Power',mind:'Science daily reveals new wonders — distant galaxies, tiny atoms, complex cells — all testifying to limitless power.',heart:'When you feel helpless, remember that the God who created this vast universe can certainly solve your small problems.',verse:'His command, when He wills something, is only to say to it: Be! And it is.',verseRef:'Surah Ya-Sin 36:82',reflection:'Contemplate a single drop of water — what wonders it contains! Imagine the One who created it.',young:'God created huge galaxies and tiny cells — His power has no limits! 💫'},
    fr:{title:'La Puissance Absolue de Dieu',mind:'La science revele chaque jour de nouvelles merveilles — galaxies lointaines, atomes minuscules, cellules complexes — temoignant d\'une puissance sans limites.',heart:'Quand vous vous sentez impuissant, rappelez-vous que Dieu qui a cree cet immense univers peut certainement resoudre vos petits problemes.',verse:'Son commandement, quand Il veut quelque chose, est de dire : Sois ! Et c\'est.',verseRef:'Sourate Ya-Sin 36:82',reflection:'Contemplez une seule goutte d\'eau — quelles merveilles elle contient ! Imaginez Celui qui l\'a creee.',young:'Dieu a cree d\'enormes galaxies et de minuscules cellules — Sa puissance est sans limites ! 💫'}
  },
  {
    id:3, emoji:'🎯', theme:'god',
    ar:{title:'دحض نظرية الصدفة',mind:'احتمال نشوء الحياة بالصدفة أقل من احتمال أن يكتب قرد على آلة كاتبة قصيدة شعرية. العلماء أنفسهم أقروا باستحالة الصدفة.',heart:'القلب المؤمن يرى في كل شيء حكمة وغاية. الصدفة لا تصنع جمالاً ولا نظاماً.',verse:'أَمْ خُلِقُوا مِنْ غَيْرِ شَيْءٍ أَمْ هُمُ الْخَالِقُونَ',verseRef:'سورة الطور ٥٢: ٣٥',reflection:'هل يمكن أن ينتج انفجار في مطبعة كتاباً منظماً؟ كذلك الكون لا ينتج عن صدفة.',young:'هل يمكن أن تهز علبة ألوان فتخرج لوحة جميلة؟ مستحيل! الكون أيضاً ليس صدفة! 🎨'},
    en:{title:'Debunking the Chance Theory',mind:'The probability of life arising by chance is less than a monkey randomly typing a poem. Scientists themselves admit chance is impossible.',heart:'The believing heart sees wisdom and purpose in everything. Chance creates neither beauty nor order.',verse:'Were they created by nothing, or were they themselves the creators?',verseRef:'Surah At-Tur 52:35',reflection:'Can an explosion in a printing press produce an organized book? Likewise, the universe cannot arise from chance.',young:'Can you shake a box of colors and get a beautiful painting? Impossible! The universe is not by chance either! 🎨'},
    fr:{title:'Refuter la Theorie du Hasard',mind:'La probabilite que la vie naisse par hasard est moindre qu\'un singe tapant un poeme au hasard. Les scientifiques eux-memes admettent l\'impossibilite du hasard.',heart:'Le coeur croyant voit sagesse et dessein en tout. Le hasard ne cree ni beaute ni ordre.',verse:'Ont-ils ete crees a partir de rien, ou sont-ils eux-memes les createurs ?',verseRef:'Sourate At-Tur 52:35',reflection:'Une explosion dans une imprimerie peut-elle produire un livre organise ? Le hasard ne peut creer l\'univers.',young:'Pouvez-vous secouer une boite de couleurs et obtenir un tableau ? Impossible ! L\'univers non plus ! 🎨'}
  },
  {
    id:4, emoji:'☝️', theme:'god',
    ar:{title:'التوحيد الخالص',mind:'وحدة القوانين الكونية تدل على وحدة الخالق. لو كان هناك أكثر من إله لفسد النظام.',heart:'التوحيد يحرر القلب من الخوف والتبعية لغير الله. من عرف الله الواحد لم يخف شيئاً سواه.',verse:'لَوْ كَانَ فِيهِمَا آلِهَةٌ إِلَّا اللَّهُ لَفَسَدَتَا',verseRef:'سورة الأنبياء ٢١: ٢٢',reflection:'حرر قلبك من كل تعلق بغير الله — التوحيد هو الحرية الحقيقية.',young:'تخيّل لو كان هناك ملكان لمدرسة واحدة — ستصبح فوضى! الكون يحتاج إلهاً واحداً! 👑'},
    en:{title:'Pure Monotheism (Tawhid)',mind:'The unity of cosmic laws points to the unity of the Creator. If there were multiple gods, the system would collapse.',heart:'Monotheism frees the heart from fear and dependence on anything other than God. Whoever knows the One God fears nothing else.',verse:'Had there been gods besides God, both [heavens and earth] would have been in ruin.',verseRef:'Surah Al-Anbiya 21:22',reflection:'Free your heart from every attachment besides God — true monotheism is true freedom.',young:'Imagine two principals for one school — chaos! The universe needs One God! 👑'},
    fr:{title:'Le Monotheisme Pur (Tawhid)',mind:'L\'unite des lois cosmiques indique l\'unite du Createur. S\'il y avait plusieurs dieux, le systeme s\'effondrerait.',heart:'Le monotheisme libere le coeur de la peur et de la dependance envers quoi que ce soit d\'autre que Dieu.',verse:'S\'il y avait des dieux en dehors de Dieu, tous deux [ciel et terre] seraient en ruine.',verseRef:'Sourate Al-Anbiya 21:22',reflection:'Liberez votre coeur de tout attachement autre que Dieu — le vrai monotheisme est la vraie liberte.',young:'Imaginez deux directeurs pour une seule ecole — le chaos ! L\'univers a besoin d\'un seul Dieu ! 👑'}
  },
  {
    id:5, emoji:'🔬', theme:'science',
    ar:{title:'العلم يقود إلى الإيمان',mind:'أعظم العلماء في التاريخ آمنوا بالله. نيوتن، أينشتاين، وغيرهم رأوا في الكون دليلاً على خالق عظيم.',heart:'كلما زاد علم الإنسان زاد خشوعه أمام عظمة الخالق. العلم الحقيقي يزيد الإيمان ولا ينقصه.',verse:'إِنَّمَا يَخْشَى اللَّهَ مِنْ عِبَادِهِ الْعُلَمَاءُ',verseRef:'سورة فاطر ٣٥: ٢٨',reflection:'اقرأ عن عجائب الخلية أو المجرة — ستجد إيمانك يزداد مع كل اكتشاف.',young:'أعظم العلماء كانوا مؤمنين — كلما تعلمت أكثر اقتربت من الله أكثر! 🔭'},
    en:{title:'Science Leads to Faith',mind:'The greatest scientists in history believed in God. Newton, Einstein, and others saw in the universe evidence of a great Creator.',heart:'The more knowledge a person gains, the more humbled they become before the Creator\'s greatness. True science increases faith.',verse:'Only those who have knowledge truly fear God among His servants.',verseRef:'Surah Fatir 35:28',reflection:'Read about the wonders of a cell or a galaxy — your faith will grow with each discovery.',young:'The greatest scientists believed in God — the more you learn, the closer you get to Him! 🔭'},
    fr:{title:'La Science Mene a la Foi',mind:'Les plus grands scientifiques de l\'histoire croyaient en Dieu. Newton, Einstein et d\'autres voyaient dans l\'univers la preuve d\'un grand Createur.',heart:'Plus on acquiert de connaissances, plus on est humble devant la grandeur du Createur. La vraie science augmente la foi.',verse:'Parmi Ses serviteurs, seuls les savants craignent vraiment Dieu.',verseRef:'Sourate Fatir 35:28',reflection:'Lisez sur les merveilles d\'une cellule ou d\'une galaxie — votre foi grandira a chaque decouverte.',young:'Les plus grands scientifiques croyaient en Dieu — plus on apprend, plus on se rapproche de Lui ! 🔭'}
  },
  {
    id:6, emoji:'🧬', theme:'science',
    ar:{title:'عجائب الخلق في الجسم',mind:'في جسم الإنسان ٣٧ تريليون خلية، كل واحدة منها أعقد من أي مصنع بشري. هذا التعقيد يستحيل أن يكون عشوائياً.',heart:'جسدك أمانة من الله — تأمّل فيه لتعرف عظمة من خلقك وصوّرك.',verse:'لَقَدْ خَلَقْنَا الْإِنسَانَ فِي أَحْسَنِ تَقْوِيمٍ',verseRef:'سورة التين ٩٥: ٤',reflection:'ضع يدك على قلبك — هذا القلب ينبض ١٠٠ ألف مرة يومياً دون أن تطلب منه!',young:'قلبك ينبض ١٠٠,٠٠٠ مرة كل يوم من غير ما تطلب منه! من صنع هذا؟ الله! ❤️'},
    en:{title:'Wonders of Creation in the Body',mind:'The human body has 37 trillion cells, each more complex than any human factory. This complexity cannot be random.',heart:'Your body is a trust from God — contemplate it to know the greatness of the One who created you.',verse:'We have certainly created man in the best form.',verseRef:'Surah At-Tin 95:4',reflection:'Place your hand on your heart — it beats 100,000 times daily without you asking it to!',young:'Your heart beats 100,000 times every day without you asking! Who made this? God! ❤️'},
    fr:{title:'Merveilles de la Creation dans le Corps',mind:'Le corps humain compte 37 mille milliards de cellules, chacune plus complexe que toute usine humaine. Cette complexite ne peut etre aleatoire.',heart:'Votre corps est un depot de Dieu — contemplez-le pour connaitre la grandeur de Celui qui vous a cree.',verse:'Nous avons certes cree l\'homme dans la meilleure forme.',verseRef:'Sourate At-Tin 95:4',reflection:'Posez votre main sur votre coeur — il bat 100 000 fois par jour sans que vous le lui demandiez !',young:'Votre coeur bat 100 000 fois par jour sans que vous le demandiez ! Qui a fait cela ? Dieu ! ❤️'}
  },
  {
  ...
  },
  {
    ...
    ar:{title:'الرد على الإلحاد',mind:'الملحد يؤمن بأن اللاشيء أنتج كل شيء، وأن الفوضى أنتجت النظام، وأن العبث أنتج الحكمة. هذا أبعد عن المنطق من الإيمان.',heart:'الإلحاد يترك القلب فارغاً بلا معنى ولا أمل. الإيمان يملأ الفراغ ويعطي الحياة هدفاً.',verse:'أَمْ خُلِقُوا مِنْ غَيْرِ شَيْءٍ أَمْ هُمُ الْخَالِقُونَ',verseRef:'سورة الطور ٥٢: ٣٥',reflection:'إذا سألك أحد: لماذا تؤمن بالله؟ فقل: لأن كل شيء حولي يشهد بوجوده.',young:'هل يمكن أن تبني بيتاً من غير بنّاء؟ كذلك الكون لا يمكن أن يكون بلا خالق! 🏗️'},
...
const INSIGHTS = [
  ...
  {
    id:2, emoji:'❤️',
    ar:{title:'القلب والعقل معاً',desc:'لا يكفي العقل وحده ولا القلب وحده. الإيمان الكامل يجمع بين الحجة العقلية والذوق الروحي.',mind:'العقل يُثبت والقلب يُذوق. كلاهما طريق إلى الله.',heart:'من اعتمد على العقل فقط جفّ قلبه، ومن اعتمد على القلب فقط ضلّ عقله.'},
    en:{title:'Heart and Mind Together',desc:'Neither mind alone nor heart alone suffices. Complete faith combines rational proof and spiritual experience.',mind:'The mind proves and the heart tastes. Both are paths to God.',heart:'Who relies only on mind dries their heart; who relies only on heart loses their way.'},
    fr:{title:'Coeur et Raison Ensemble',desc:'Ni la raison seule ni le coeur seul ne suffit. La foi complete allie preuve rationnelle et experience spirituelle.',mind:'La raison prouve et le coeur goute. Les deux sont des chemins vers Dieu.',heart:'Qui ne compte que sur la raison desseche son coeur ; qui ne compte que sur le coeur perd sa voie.'}
  },
  {
    id:3, emoji:'🔭',
  ...
  {
    id:5, emoji:'⚡',
    ar:{title:'الإيمان قوة لا ضعف',desc:'المؤمن الحق قوي، شجاع، فاعل في المجتمع. الإيمان الصحيح يصنع حضارات لا يُضعف الأمم.',mind:'التاريخ يشهد: كل نهضة إسلامية بدأت بتجديد الإيمان.',heart:'الإيمان يمنحك قوة داخلية لمواجهة أصعب التحديات بثبات.'},
    en:{title:'Faith Is Strength, Not Weakness',desc:'The true believer is strong, brave, and active in society. True faith builds civilizations, it does not weaken nations.',mind:'History testifies: every Islamic renaissance began with renewing faith.',heart:'Faith gives you inner strength to face the toughest challenges with steadfastness.'},
    fr:{title:'La Foi Est Force, Pas Faiblesse',desc:'Le vrai croyant est fort, courageux et actif dans la societe. La vraie foi construit des civilisations.',mind:'L\'histoire temoigne : chaque renaissance islamique a commence par le renouvellement de la foi.',heart:'La foi vous donne une force interieure pour affronter les defis les plus difficiles avec fermete.'}
  }
];
